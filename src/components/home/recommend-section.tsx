...
export default function ClientRecommendSection() {
  return (
    <Card className="border-0 dark:bg-gray-950 rounded-t-2xl p-0 bg-card-0 gap-0 ">
      <CardHeader className="flex items-center justify-between bg-white p-4 lg:sticky lg:top-24 lg:z-20 ">
